...
CREATE TABLE `__new_user_key` (
	...
	`updated_at` integer DEFAULT '"2025-02-20T05:00:07.213Z"' NOT NULL,
...
ALTER TABLE `auth_attempt` DROP COLUMN `ip_address`;--> statement-breakpoint
ALTER TABLE `auth_attempt` DROP COLUMN `user_agent`;