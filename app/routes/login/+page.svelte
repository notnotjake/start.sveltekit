		...
		>
			...
			<div class="relative flex h-11 w-full flex-col items-center">
				...
				<button
					...
					aria-label="Continue"
					class="disabled: group absolute right-0 top-0 flex h-full w-fit items-center justify-end rounded-2xl pr-3"
				>
					<svg
						...
						height="16"
						fill="currentColor"
						class="bi bi-arrow-right-circle-fill h-6 w-6 cursor-pointer p-[0.1rem] text-[hsl(211,100%,58%)] group-disabled:text-neutral-500/80"
						viewBox="0 0 16 16"
					>
						<path
