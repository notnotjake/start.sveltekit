	...
	>
		...
		>
			...
			<input
				...
				class={createClass(
					'h-full w-full flex-grow-1 pl-4 font-[450] text-zinc-900 transition-all outline-none selection:bg-sky-200 selection:text-blue-600 placeholder:font-medium placeholder:text-neutral-500'
				)}
				onclick={toggleInput}
				onfocus={toggleInput}
			/>
